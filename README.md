...
Student-Placement-Predictor/
├── datasets/
│ ├── cse_questions.csv # CSE branch questions
│ ├── ece_questions.csv # ECE branch questions
│ ├── eee_questions.csv # EEE branch questions
│ ├── mech_questions.csv # Mechanical branch questions
│ └── civil_questions.csv # Civil branch questions
...
2. Skill levels are selected based on knowledge
3. System generates a branch-specific technical test
4. Student attempts the test within a time limit
5. Answers are evaluated and score is calculated
6. Placement probability is predicted
7. Job roles and learning resources are recommended
